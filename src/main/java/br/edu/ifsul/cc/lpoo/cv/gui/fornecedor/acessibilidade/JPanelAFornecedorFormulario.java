...
public class JPanelAFornecedorFormulario extends JPanel implements ActionListener {
        ...
        public Fornecedor getFornecedorbyFormulario() {
            ...
            if (txfNickname.getText().trim().length() > 4 && new String(txfSenha.getPassword()).trim().length() > 3) {
        ...
        public void setFornecedorFormulario(Fornecedor f) {
            ...
            if (f == null) {//se o parametro estiver nullo, limpa o formulario
                ...
                txfDataCadastro.setText(format.format(fornecedor.getData_cadastro().getTime()));
                txfDataNascimento.setText(format.format(fornecedor.getData_nascimento().getTime()));
